...
const NavBar: FC = () => {
      ...
      },
      {
         label: (
            <Switch
               ...
               checkedChildren={
                  <svg fill="white" xmlns="http://www.w3.org/2000/svg" height="20" viewBox="0 -960 960 960" width="20">
   ...
   return <Menu mode="horizontal" defaultSelectedKeys={["home"]} items={items} />;
};
